layui.define(['laypage', 'form'], function (exports) {
	...
	// 引入组件才加载对应的css
	layui.link(layui.cache.base + 'pear/css/module/iconPicker.css')
	...
	IconPicker.prototype.render = function (options) {
		...
		var a = {
			...
			createList: function (text) {
				var d = data,
					l = d.length,
					pageHtml = '<div style="min-width: 260px"></div>',
			...
			getData: {
				fontClass: function () {
					var arr = ["layui-icon-rate-half", "layui-icon-rate", "layui-icon-rate-solid",
						...
						'layui-icon-gift', 'layui-icon-cols', 'layui-icon-key', 'layui-icon-heart',
