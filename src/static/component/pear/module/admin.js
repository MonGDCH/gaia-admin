layui.define(['jquery', 'element', 'form', 'tab', 'menu', 'frame', 'theme', 'fullscreen'], function (exports) {
	"use strict";
	...
	const pearAdmin = new function () {
		// 渲染框架页
		this.render = async function (initConfig) {
			// 渲染框架页
			await applyConfig(initConfig || {});
		}
	...
	async function applyConfig(param) {
		config = param;
